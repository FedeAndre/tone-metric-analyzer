...
RUN mkdir -p /app/.tone_metric_cache \
    ...
    && ! grep -R "build_hits_from_canonical_score" /app/app.py /app/tone_metric /app/tests \
    && ! grep -R "build_layer_anchors_from_canonical_score" /app/app.py /app/tone_metric /app/tests \
    && ! grep -R "canonical_recovered" /app/app.py /app/tone_metric /app/tests \
    && ! grep -R "canonical_score_meta" /app/app.py /app/tone_metric /app/tests \
