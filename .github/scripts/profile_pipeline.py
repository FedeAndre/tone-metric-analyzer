...
symbolic, omr = stage('audiveris_transcribe_export_omr', lambda: pdf_to_musicxml(pdf, session))
annotation, annotation_warning = stage('audiveris_annotation_only', lambda: pdf_to_annotations(pdf, session))
